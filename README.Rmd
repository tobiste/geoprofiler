...
The goal of `{geoprofiler}` is to get accurate distances along and across user-defined 
...
> Note: You can also create a profile line by a direction via `geoprofiler()`

...
The function `swath_extract()` requires the profile line, the raster file, and 
...
Next, we calculate some statistics of the elevation across the swath, such as 
min/max, mean and standard deviation using the function `swath_profile()`. We 
